...
export default defineEventHandler(async (event) => {
  ...
  return {
    ...
    discordMentionEnabled: config.discordMentionEnabled ?? false,
    discordMentionRoleId: config.discordMentionRoleId ?? '',
    discordMentionMaxMessages: config.discordMentionMaxMessages ?? 6,
